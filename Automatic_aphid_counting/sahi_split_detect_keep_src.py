...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        #use image with the original resolution rather than 640x640
        im = original_src
        ...
        if mulpicplus == "1":
            ...
            '''
            # Refer to SAHI split, the input sise must large than the slice_size
...
def parse_opt():
    ...
    parser.add_argument('--sliced_height', type=int, default=640, help='sliced_height')
    parser.add_argument('--sliced_width', type=int, default=640, help='sliced_width')
