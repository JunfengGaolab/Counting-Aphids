...
def run(
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        for si, pred in enumerate(out):
            ...
            #if False: # for CSRNet_Aphid_dataset_1 412_2000_epochs_augument-trainingset/0model_best.pth.tar
            ...
            #print('paths[si]:',paths[si])
                ...
                #checkpoint = torch.load('./weights/CSRNet_Aphid_dataset_1/0model_best.pth.tar')

                #checkpoint = torch.load('./CSRNet-pytorch-master/result/aphids_images_63_second_reverse_augument-trainingset/0model_best.pth.tar')

                #checkpoint = torch.load('./CSRNet-pytorch-master/result/aphids_images_412_2000_epochs_augument-trainingset/0model_best.pth.tar')
