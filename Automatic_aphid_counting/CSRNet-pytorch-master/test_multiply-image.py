...
#checkpoint = torch.load('0model_best.pth.tar') #best model
checkpoint = torch.load('0checkpoint.pth.tar') #final model
model.load_state_dict(checkpoint['state_dict'])
#checkpoint = torch.load('models/model_best.pth')#修改
#model.load_state_dict(checkpoint)

img_paths = './Shanghai/part_A_final/other_data/images/'
h5_paths = './Shanghai/part_A_final/other_data/ground_truth/'
#save_path = './result/aphids_images_39_second_converse_no_augument/test_result/'
save_path = './Shanghai/part_A_final/other_data/ground_truth/'

#aths = './Shanghai/part_A_final/other_data/images/'
#h5_paths = './Shanghai/part_A_final/other_data/ground_truth/'
#save_path = './Shanghai/part_A_final/other_data/ground_truth/'
